                ...
                "render": function (data) { //data will be the id
                    return `
                        <div class="text-center">
                            <a title="Editare" href="/Admin/CoverType/Upsert/${data}" class="btn-sm btn-success text-white" style="cursor:pointer; margin-right:16px;"><i class="fas fa-edit"></i></a>

                            <a title="Stergere" onclick=Delete("/Admin/CoverType/Delete/${data}") class="btn-sm btn-danger text-white" style="cursor:pointer">
